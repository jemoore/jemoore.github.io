...
The laptop is an HP Envy X360. It probably falls into the category of a budget laptop. However, it is equipped with an Intel® Core™ i5-7200U CPU @ 2.50GHz, 12 GB RAM, a 15 inch 1920x1080 touch screen, a 1 TB HDD (at the time of purchase), and a number of ports (USB 3.0, USB C, HDMI, SD card reader). The display will fold all the way back for ‘tablet’ mode, which I have found usefull when looking through family photos.

I had actually purchased the same model for my wife and I was so impressed by the quality to cost ratio that I bought one for myself a month or two later. (I believe I purchased both units on sale for around $600 each).
...
*   Place a soft cloth on your work area to protect the laptop.
*   Turn the laptop upside down with the screen hinges away from you.
...
1.  Remove the screws on the bottom panel. On the bottom panel remove:
    *   6 Torx screws
    *   2 Phillips screws
...
[![](/img/ssd1.png)](/img/ssd1.png)

Bottom of laptop.

1.  Use a pry tool inserted behind the hinge to lift up the bottom panel. Do this at both hinges. This should release the bottom panel along the back.
    
    [![](/img/ssd2.png)](/img/ssd2.png) [![](/img/ssd2-2.png)](/img/ssd2-2.png)
    
    Pry at hinge.
    
2.  Along the back of the bottom panel near its center, lift up and forward on the bottom panel (imagine an arc where the front edge of the panel is stationary). You will have to apply an unsettling amount of force here to get the side tabs to pop free. You should then be able to lift the panel free of the casings front edge.
    
    [![](/img/ssd3.png)](/img/ssd3.png)
...
1.  Disconnect the battery. Identify the battery connecter on the motherboard in the photo below. The connector has no latches so should slide out easily. Use a pry tool as needed on each side to gently back out the connector.
2.  Remove the 6 Phillips P0 screws holding the battery.
3.  Lift the battery free of the case and set it aside.
    
    [![](/img/ssd4.png)](/img/ssd4.png)
...
The ribbon cable connector on the motherboard has a latch that must be lifted so the cable can slide out.
...
[![](/img/ssd-rcc.png)](/img/ssd-rcc.png)

Motherboard Ribbon Cable Connector.
...
For me this was perhaps the most difficult step of the process. The ribbon cable is very delicate and I was worried I would accidentally rip the cable from the connector. You must apply equal force on both sides of the ribbon cable connector in order to get it to slide off of the HDD/SSD.

[![](/img/ssd-rc.png)](/img/ssd-rc.png)
...
Power on the laptop and see if it passes the smoke test. We all know that electronics are powered by magic smoke. If you connect something wrong the magic smoke escapes and your device will no longer work.
...
*   [https://support.hp.com/us-en/product/hp-envy-m6-aq100-x360-convertible-pc/12499188/model/13475168/manuals](https://support.hp.com/us-en/product/hp-envy-m6-aq100-x360-convertible-pc/12499188/model/13475168/manuals)
*   [http://h10032.www1.hp.com/ctg/Manual/c05098448](http://h10032.www1.hp.com/ctg/Manual/c05098448)
