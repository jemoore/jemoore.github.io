...
If you read my previous blog post [“How to replace the SSD in an HP Envy X360 laptop”](/posts/ssd-hp-x360/) then this section title should look familiar.

In case you didn’t read that previous post, I upgraded my 500 GB SSD to a 1 TB SSD. This process will describe how I cloned the existing SSD and the problems I encountered (along with solutions). Please note that this is not a tutorial about using a specific tool for cloning. This article is more generic and written to mainly capture the mistakes I made so that I hopefully do not make them next time.
...
*   Never confuse the source and destination partitions / drives
    *   _Thanks Captain Obvious_. This is such a simple thing but easy to get backwards. Especially if you switch the SSDs and the new SSD will not boot and you have to use this tool again (see below).
...
Installing the new SSD went smoothly, see [“How to replace the SSD in an HP Envy X360 laptop.”](/posts/ssd-hp-x360/)
